            ...
            <ul class="nav">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="{{ url('/servicios/consulta') }}">
                        <i class="mdi mdi-cloud-search-outline menu-icon"></i>
                        <span class="menu-title">Consulta por Token</span>
                    </a>
                </li>
                ...
                <li class="nav-item">
                    ...
                    <div class="collapse" id="ui-basic">
                        <ul class="nav flex-column sub-menu">
                            <li class="nav-item">
                                <a class="nav-link" href="{{ url('/taxis/crear') }}">Agregar</a>
                            </li>
                            <li class="nav-item">
                    ...
                    <div class="collapse" id="ui-basic1">
                        <ul class="nav flex-column sub-menu">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="{{ url('/register') }}">Agregar</a>
                            </li>
                            <li class="nav-item">
